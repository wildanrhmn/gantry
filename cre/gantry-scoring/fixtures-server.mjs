...
const traders = [
  ...
  { id: "0x66a9893cc07d91d95644aedd05d03f95e1dba8af", swaps: 3580, blocks: 1500,
    ...
    firstBlock: 25940000, lastBlock: 25941500, failedAttempts: 649 },
  // A dedicated sandwich bot: same behaviour, one originator. Its reverted attempts
  // come from transaction traces, which is the part a subgraph structurally cannot see.
  { id: "0x9205a569b0ff45df1e4f5ae48e21bc7f0656f0bb", swaps: 680, blocks: 300,
    ...
    firstBlock: 25940000, lastBlock: 25941500, failedAttempts: 31 },
  { id: "0x76f30e3f75437fb862b8d2c4d80a671bceba5b1a", swaps: 210, blocks: 140,
    ...
    firstBlock: 25940100, lastBlock: 25941400, failedAttempts: 12 },
  ...
  { id: "0xaaf4b27e0d0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f", swaps: 240, blocks: 240,
    ...
    firstBlock: 25930000, lastBlock: 25941500, failedAttempts: 0 },
